...
- (void)bannerDidLoad:(BIDBannerView *)adView adInfo:(BIDAdInfo *)adInfo
{
...
- (void)bannerDidFailToDisplay:(BIDBannerView *)adView adInfo:(nonnull BIDAdInfo *)adInfo error:(nonnull NSError *)error
{
